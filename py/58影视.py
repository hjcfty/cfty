...
class Spider(Spider):
    ...
    def init(self, extend=''):
        ...
        self.home_url = 'shturl.cc/2iSiEqB4RMGCb'
        ...
        self.uuid_val = ''
        self.secret = ''
        self.img_cdn = 'https://cstp.58ysapp.cn'
    ...
    def playerContent(self, flag, pid, vipFlags):
        try:
            ...
            print(f'[天扬在线] playerContent error: {e}')
            return {'url': self.error_url, 'header': '', 'parse': 0, 'jx': 0}
